...
typedef struct tagCFG_ACCESS_EVENT_INFO
{
    ...
    bool				abSpecialDaysOpenAlwaysTime;	// nSpecialDaysOpenAlwaysTime字段是否下发: true 不下发, false 下发
	bool				abSpecialDaysCloseAlwaysTime;	// nSpecialDaysCloseAlwaysTime字段是否下发: true 不下发, false 下发
